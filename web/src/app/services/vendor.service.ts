...
export class VendorService {
  ...
  addVendorHelper(key, farmKey, form) {
    ...
    let v = {
      ...
      imageUrl: key ? `https://lungau.s3.eu-central-1.amazonaws.com/${key}` : 'https://lungau.s3.eu-central-1.amazonaws.com/dummies/dummy_vendor.png',
      imageKey: key,
  ...
  updateVendorHelper(vendor, form, key, farmKey) {
    ...
    let v = {
      ...
      email: vendor.email,
      description: form.description,
      imageUrl: key ? `https://lungau.s3.eu-central-1.amazonaws.com/${key}` : form.imageUrl ? form.imageUrl : 'https://lungau.s3.eu-central-1.amazonaws.com/dummies/dummy_vendor.png',
